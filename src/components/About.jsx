...
const About = () => {
  return (
    <div>
      <h2 style={{ fontWeight: "bold", textAlign: "center" }}>ABOUT</h2>
      <div style={{ display: "flex", justifyContent: "flex-start" }}>
        ...
        <p>
          ...
          the needs of the agony of the choice. We hate the fellow.<br></br>{" "}
          ...
          are accusing him? Him whom something large cisterns. The things we are
          accusing of these in the explication of the truth receives from the
          flattery of her will never be the trouble and they are refused to the
          pleasures and the pleasures of the pain, explain the treatment of
      ...
      <p>
        I never said will unfold in him
        receives at another time he may please the one that those works, we are
        less than they, this refused to the pleasures of deleniti? Those are!
